...
% This demo is used to present the case of Warm Core Eddy, highlighting the high efficiency of the segmentation scheme  
...
% Environment setup
[grid, env, casename] = read_env('input6.env'); % Load env file
